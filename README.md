[![npm](https://img.shields.io/npm/v/@patrtorg/iure-aliquid.svg)](https://www.npmjs.com/package/@patrtorg/iure-aliquid) ![downloads](https://img.shields.io/npm/dt/@patrtorg/iure-aliquid.svg) [![CI](https://github.com/patrtorg/iure-aliquid/actions/workflows/ci.yml/badge.svg)](https://github.com/patrtorg/iure-aliquid/actions)
...
- Install by executing `npm install @patrtorg/iure-aliquid` or `yarn add @patrtorg/iure-aliquid`.
- Import by adding `import DatePicker from '@patrtorg/iure-aliquid'`.
...
[Online demo](https://projects.wojtekmaj.pl/@patrtorg/iure-aliquid/) is also available!
...
Add React-Date-Picker to your project by executing `npm install @patrtorg/iure-aliquid` or `yarn add @patrtorg/iure-aliquid`.
...
import DatePicker from '@patrtorg/iure-aliquid';
...
```ts
import '@patrtorg/iure-aliquid/dist/DatePicker.css';
...
| className            | Class name(s) that will be added along with `"@patrtorg/iure-aliquid"` to the main React-Date-Picker `<div>` element.                                                                                                                                                                                                                           | n/a                                   | <ul><li>String: `"class1 class2"`</li><li>Array of strings: `["class1", "class2 class3"]`</li></ul>                                                                                                                 |
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@patrtorg/iure-aliquid#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@patrtorg/iure-aliquid#sponsors" target="_blank"><img src="https://opencollective.com/@patrtorg/iure-aliquid/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@patrtorg/iure-aliquid#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@patrtorg/iure-aliquid#backers" target="_blank"><img src="https://opencollective.com/@patrtorg/iure-aliquid/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@patrtorg/iure-aliquid/contributors.svg?width=890&button=false)
